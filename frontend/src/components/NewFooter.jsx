...
const LINKS = [
  {
    title: "Products",
    items: ["Medicines", "Healthcare", "Personal Care", "Medical Devices"],
  },
  {
    title: "Services",
    items: ["Prescriptions", "Health Advice", "Delivery", "Refills"],
  },
  {
    title: "Information",
    items: ["About Us", "Contact", "FAQs", "Help Center"],
  },
];
    ...
    <footer className="relative w-full bg-blue-600 border-t border-white/20 shadow-lg backdrop-blur-sm">
      <div className="mx-auto w-full max-w-7xl px-8 py-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <Typography variant="h5" className="mb-6 text-white font-bold">
            MediCart
          </Typography>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-white/20 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} MediCart. All Rights Reserved.
          </Typography>

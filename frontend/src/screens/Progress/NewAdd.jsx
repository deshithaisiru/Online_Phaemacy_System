          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onInvalid={(e) => e.target.setCustomValidity("Please enter a valid week number (1 or higher).")}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                onInvalid={(e) => e.target.setCustomValidity("Please enter a valid weight (1 or higher).")}
                onInput={(e) => e.target.setCustomValidity("")}
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                onInvalid={(e) => e.target.setCustomValidity("Please enter a valid height (1 or higher).")}
                onInput={(e) => e.target.setCustomValidity("")}
              />
            </div>
            <div>
